...
<h2>Edit the Infromation</h2>
<hr>
<form method="POST" name="createUser" action="<?php echo base_url().'index.php/Users/update/'.$update_user['id']; ?>">
<!-- row start-->
...
<label>Name</label>
<input type="text" name='name' value="<?php echo set_value('name', $update_user['name']);?>" class="form-control">
...
<label>Email</label>
<input type="text" name='email' value="<?php echo set_value('email', $update_user['email']); ?>" class="form-control">
